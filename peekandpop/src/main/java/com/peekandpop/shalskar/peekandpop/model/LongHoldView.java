...
public class LongHoldView {
  ...
  /**
   * Sets a timer on the long hold view that will send a long hold event after the duration If
   * receiveMultipleEvents is true, it will set another timer directly after for the duration * 1.5
   *
   * @param position
   * @param duration
   */
  public void startLongHoldViewTimer(
      @NonNull final PeekAndPop peekAndPop, final int position, final long duration) {
