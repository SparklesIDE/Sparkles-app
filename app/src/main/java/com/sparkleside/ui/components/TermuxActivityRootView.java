...
public class TermuxActivityRootView extends LinearLayout
  ...
  public TermuxActivityCompat mActivity;
  ...
  public void setActivity(TermuxActivityCompat activity) {
    mActivity = activity;
  }
  ...
  public void onGlobalLayout() {
    ...
    boolean isVisibleBecauseMargin =
        (windowAvailableRect.bottom == bottomSpaceViewRect.bottom) && params.bottomMargin > 0;
