...
public class TerminalActivity extends BaseActivity {
    ...
    private void setupVirtualKeys() throws JSONException {
        ...
        binding.extraKeys.reload(new VirtualKeysInfo(VIRTUAL_KEYS, "", VirtualKeysConstants.CONTROL_CHARS_ALIASES));
    }
    ...
    private TerminalSession createSession() {
        ...
        String[] env = {"HOME=" + getFilesDir().getAbsolutePath(), "PUBLIC_HOME=" + getExternalFilesDir(null).getAbsolutePath(), "COLORTERM=truecolor", "TERM=xterm-256color"};
        ...
        return new TerminalSession(shell, getFilesDir().getAbsolutePath(), args, env, TerminalEmulator.DEFAULT_TERMINAL_TRANSCRIPT_ROWS, backEnd);
    }
